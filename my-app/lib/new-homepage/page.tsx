...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center px-6 py-20 overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center opacity-5 pointer-events-none">
          <div className="relative w-[800px] h-[800px]">
            <Image src="/logo-icon.png" alt="Rendlr" fill className="object-contain animate-pulse" />
          </div>
        </div>
        ...
        <div
          className={`relative z-10 max-w-6xl mx-auto text-center space-y-8 transition-all duration-1000 ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
          }`}
        >
          <div className="flex justify-center mb-8">
            <div className="relative w-32 h-32 animate-float">
              <Image src="/logo-icon.png" alt="Rendlr" fill className="object-contain drop-shadow-2xl" />
            </div>
          </div>

          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-sm font-medium text-white mb-6 hover:bg-white/20 transition-all duration-300 hover:scale-105">
            <Sparkles className="h-4 w-4 animate-pulse" />
            Based in Carlsbad, CA
          </div>

          <h1 className="text-5xl md:text-7xl font-bold tracking-tight text-balance text-white">
            <span className="text-6xl md:text-8xl bg-gradient-to-r from-white via-primary to-chart-1 bg-clip-text text-transparent animate-gradient bg-[length:200%_auto]">
              Rendlr
            </span>
            <br />
          ...
          <p className="text-xl md:text-2xl text-gray-200 max-w-3xl mx-auto text-balance leading-relaxed">
            <span className="font-semibold text-white">Rendlr</span> builds modern, secure, and high-performing websites
            designed to grow your business. Everything you need to succeed online in one place.
          </p>

          {/* Trust indicators */}
          <div className="flex flex-wrap gap-8 justify-center pt-12 text-sm text-gray-300">
            {[
      ...
      >
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-3 pointer-events-none">
        ...
        <div className="mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8 relative z-10">
          <div className="mb-16 space-y-4 text-center fade-in-section opacity-0 transition-all duration-1000">
            <h2 className="text-4xl md:text-5xl font-bold tracking-tight text-balance">
              What <span className="text-primary">Rendlr</span> Does
            </h2>
            ...
            {[
              ...
              >
                ...
                <CardHeader className="relative">
                  <div className="mb-4 inline-flex h-14 w-14 items-center justify-center rounded-xl bg-primary/10 text-primary group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 shadow-lg group-hover:shadow-primary/50">
            ...
            <div className="space-y-8 fade-in-section opacity-0 transition-all duration-1000">
              ...
              <div className="space-y-6">
                {[
                  ...
                  >
                    <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-primary/10 text-primary group-hover:scale-110 group-hover:rotate-6 transition-all duration-300 shadow-lg group-hover:shadow-primary/50">
            ...
            >
              ...
              <Card className="relative backdrop-blur-sm bg-card/50 border-border/50 p-8 transition-all duration-500">
                <div className="space-y-8">
                  {[
                    { value: "100+", label: "Websites Launched", color: "text-primary" },
                    { value: "98%", label: "Client Satisfaction", color: "text-chart-1" },
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <span className="text-xl font-bold">Rendlr</span>
              </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                {["Web Design", "SEO Optimization", "AI Integrations", "Digital Security"].map((service, index) => (
                  <li key={index}>
                    <a
                      href="#"
                      className="hover:text-foreground transition-colors hover:translate-x-1 inline-block duration-300"
                    >
                      {service}
                    </a>
                  </li>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li>Carlsbad, CA</li>
                <li>
                  <a href="mailto:hello@rendlr.com" className="hover:text-foreground transition-colors">
                    hello@rendlr.com
                  </a>
                </li>
                <li>
