// app/blog/ai-tutor-prompt-engineering/page.tsx
...
const codeSnippet = `const systemPrompt = ` + "`" + `
  ...
  return (
    <div className="container mx-auto px-4 py-10 max-w-3xl">
      ...
      <p className="text-zinc-600 dark:text-zinc-300 mb-6 text-sm">
        Posted on April 22, 2025 · Tags: <span className="italic">AI, Prompt Engineering, EdTech</span>
      </p>

      <p className="mb-4 text-zinc-700 dark:text-zinc-200">
        One of the most interesting challenges while building my AIcademy has been <strong>prompt engineering</strong>. Although I’m still relatively new to it, I’ve quickly realized how powerful good prompts can be—not just for getting accurate answers, but for shaping <em>how</em> the AI behaves as a teacher.
      </p>
      ...
      <p className="mb-4 text-zinc-700 dark:text-zinc-200">
        ...
        <ul className="list-disc pl-6 mt-2">
          <li>Ask thought-provoking questions rather than giving away answers</li>
      ...
      <p className="mb-4 text-zinc-700 dark:text-zinc-200">
        This is still evolving, but it's already changing how I think about AI—not as a replacement for learning, but as a tool to <strong>support</strong> and <strong>strengthen</strong> it. Eventually, I plan to fine-tune prompts per subject or based on student performance so that it grows more adaptive over time.
      </p>
